$(document).ready(function() {
	...
	$("#calculate-btn").on("click", function() {
		var calculateAndDisplayScore = function() {
            ...
            var eatingOutInput = document.getElementById("eatingout").value;
            ...
            if (eatingOutInput === 0 || eatingOutInput === "undefined") {
				eatingOutScore = 0;
			} else {
				eatingOutScore = eatingOutInput * 1.25;
			}
			// console.log("Eating out score is: " + eatingOutScore);
            
             if (groceriesInput === 0 || groceriesInput === "undefined") {
				groceriesScore = 0;
			} else {
				groceriesScore = groceriesInput * 0.85;
			}
			// console.log("Groceries score is: " + groceriesScore);
            
            if (document.getElementById("optionsRadio10").checked) {
				dietScore = 50;
			} else if (document.getElementById("optionsRadio11").checked) {
				dietScore = 40;
			} else if (document.getElementById("optionsRadio12").checked) {
				dietScore = 60;
			} else if (document.getElementById("optionsRadio13").checked) {
				dietScore = 70;
			} else {
				dietScore = 90;
			}
            ...
            var foodScore = eatingOutScore + groceriesScore + dietScore;

			// calculate total score and round to nearest whole integer
			totalScore = Math.round(energyScore + travelScore + wasteScore + foodScore);
        ...
        var DietOption1 = document.getElementById("optionsRadio10").checked;
		var DietOption2 = document.getElementById("optionsRadio11").checked;
		var DietOption3 = document.getElementById("optionsRadio12").checked;
		var DietOption4 = document.getElementById("optionsRadio13").checked;
        var DietOption5 = document.getElementById("optionsRadio14").checked;
        
        if (DietOption1 == false && DietOption2 == false && DietOption3 == false && DietOption4 == false && DietOption5 == false) {
			if (DietOption1 == false && DietOption2 == false && DietOption3 == false && DietOption4 == false && DietOption5 == false) {
				$("#food-alert").show();
			} else {
				$("#food-alert").hide();
